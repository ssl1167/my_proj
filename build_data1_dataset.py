...
def canonical_cnot_circuit(qc: QuantumCircuit) -> QuantumCircuit:
    ...
    decompose to CX basis, keep only CX operations, keep only CX-active qubits,
    and compactly renumber those qubits from 0 to n-1.
    """
...
def main() -> None:
    ...
    revlib_rows = collect_revlib_real(data_root / "RevLib", args.max_qubits, skips, canonicalize_cnot_only)
